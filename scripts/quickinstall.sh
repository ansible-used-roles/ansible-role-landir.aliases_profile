...
sudo env PATH=$PATH ansible-pull -U https://github.com/ansible-used-roles/ansible-role-landir.aliases_profile -d /etc/ansible/roles/ansible-role-landir.aliases_profile -i scripts/localinventory default.yml
